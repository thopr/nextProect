...
import NeedyCheckApproveM from "../components/NeedyCheckApproveM";
import { GetApproveuserssM, UserStatistics } from "../services/api_get";
...
function GiveNeedyCoubon() {
  ...
  const { data, isLoading, isError } = GetApproveuserssM();
...
export default ProtectRouteMandobe(GiveNeedyCoubon);
